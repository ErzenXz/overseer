    ...
    <div>
      <div className="flex items-center justify-between mb-8">
        <div>
          ...
          <p className="text-zinc-400 mt-1">Manage your AI model providers and API keys</p>
        </div>
        <AddProviderButton />
      </div>
      ...
      {providers.length === 0 ? (
        <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-12 text-center">
          ...
          <p className="text-zinc-400 mb-6">Add your first LLM provider to start using the AI agent</p>
            ...
            <div key={key} className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-4">
              ...
              <div className="flex flex-wrap gap-1">
                ...
                {info.models.length > 3 && (
                  <span className="text-xs text-zinc-500">+{info.models.length - 3} more</span>
                )}
              </div>
            </div>
          ))}
