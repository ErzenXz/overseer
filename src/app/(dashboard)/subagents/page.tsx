  ...
  return (
    <div>
      ...
      <div className="bg-zinc-900/50 border border-zinc-800 rounded-xl p-6 mb-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {allTypes.map((type) => {
            const config = subAgentManager.getSubAgentConfig(type);
